...
//
//    public Page<ReplyDTO> getRepliesByBoardWithPaging(Long bno, Pageable pageable) {
//        Page<Reply> replyPage = replyRepository.findByBoardOrderByRno(Board.builder().bno(bno).build(), pageable);
//        return replyPage.map(this::entityToDTO);
//    }
//
//
//    public PageInfo getReplyPageInfo(Page<ReplyDTO> replyPage) {
//        PageInfo pageInfo = new PageInfo();
//        pageInfo.setTotalElements(replyPage.getTotalElements());
//        pageInfo.setTotalPages(replyPage.getTotalPages());
//        pageInfo.setHasNextPage(replyPage.hasNext());
//        pageInfo.setHasPreviousPage(replyPage.hasPrevious());
//        pageInfo.setCurrentPage(replyPage.getNumber());
//        return pageInfo;
//    }
//
//    @Getter
